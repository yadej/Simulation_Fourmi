...
class Fourmi{
    Coord coord_;// Les coord de la fourmi
    int indice_;    // Son indice (unique pour sa colonie)
    int colonie_;// Le numéro de sa colonie
    bool sucre_; // Si elle porte du sucre
    bool Vivant_;// Si elle est vivante
    public:
    //Constructeur
